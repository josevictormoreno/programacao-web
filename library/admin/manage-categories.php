...
<head>
    ...
    <title>ATIVIDADE PRÁTICA (ATP): Projeto Coisas Emprestadas | Gerenciar Categorias</title>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h4 class="header-line">Gerenciar Categorias</h4>
                </div>
                <div class="row">
        ...
        foreach ($results as $result) { ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                                ...
                                                <a href="#" class="btn btn-success btn-xs">Ativo</a>
                                                <?php } else { ?>
                                                <a href="#" class="btn btn-danger btn-xs">Inativo</a>
                                                <?php } ?>
                                            </td>
                                            <td class="center">
                                            ...
                                            <td class="center">
                                                ...
                                                <a
                                                    ...
                                                    <a href="manage-categories.php?del=<?php echo htmlentities($result->id); ?>"
                                                        ...
                                                        btn btn-danger"><i class="fa fa-pencil"></i> Deletar</button>
                                            </td>
                                        </tr>
                                 <?php $cnt=$cnt+1;}} ?>
                                    </tbody>

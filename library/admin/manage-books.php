...
?>
	...
	<head>
		...
		<title>ATIVIDADE PRÁTICA (ATP): Projeto Coisas Emprestadas | Gerenciar Livros</title>
		...
		<div class="content-wrapper">
			<div class="container">
				<div class="row pad-botm">
					<div class="col-md-12">
						<h4 class="header-line">Gerenciar Livros</h4>
					</div>
							...
							<div class="panel-body">
								<div class="table-responsive">
									<table class="table table-striped table-bordered table-hover" id="dataTables-example">
										...
										<tbody>
											<?php $sql = "SELECT tblbooks.BookName,tblbooks.Category,tblbooks.Author,tblbooks.ISBNNumber,tblbooks.id as bookid,tblbooks.bookImage from tblbooks";
											$query = $dbh->prepare($sql);
											$query->execute();

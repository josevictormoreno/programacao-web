...
?>
	...
	<head>
		...
		<title>ATIVIDADE PRÁTICA (ATP): Projeto Coisas Emprestadas | Emprestar novo Livro</title>
		...
		<div class="content-wrapper">
			<div class="container">
				<div class="row pad-botm">
					<div class="col-md-12">
						<h4 class="header-line">Emprestar um Novo Livro</h4>
					...
					<div class="col-md-10 col-sm-6 col-xs-12 col-md-offset-1">
						<div class="panel panel-info">
							<div class="panel-heading">
								Emprestar um Novo Livro
							</div>
							<div class="panel-body">
								<form role="form" method="post">

									<div class="form-group">
										<label>Estudante<span style="color:red;">*</span></label>
										<select class="form-control" name="studentid" required="required">
											...
											if ($query->rowCount() > 0) {
												foreach ($results as $result) { ?>
													<option value="<?php echo htmlentities($result->StudentId); ?>">
									...
									<div class="form-group">
										<label>ISBN ou Título do Livro<span style="color:red;">*</span></label>
									...
									<button type="submit" name="issue" id="submit" class="btn btn-info">Emprestar Livro </button>

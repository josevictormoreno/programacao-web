...
?>
	...
	<head>
		...
		<title>ATIVIDADE PRÁTICA (ATP): Projeto Coisas Emprestadas | Gerenciar Livros Emprestados</title>
		...
		<div class="content-wrapper">
			<div class="container">
				<div class="row pad-botm">
					<div class="col-md-12">
						<h4 class="header-line">Detalhes Livros Emprestados</h4>
								...
								<form role="form" method="post">
									...
									if ($query->rowCount() > 0) {
										foreach ($results as $result) {               ?>
											...
											<div class="col-md-6">
												<div class="form-group">
													<label>Id EMAIL do Estudante :</label>
											...
											<div class="col-md-6">
												<div class="form-group">
													<label>Número de Contato do Estudante :</label>
											...
											<div class="col-md-6">
												<div class="form-group">
													<label>Data de Emprestimo do Livro :</label>
											...
											<div class="col-md-6">
												<div class="form-group">
													<label>Data de Devolução do Livro :</label>
													<?php if ($result->ReturnDate == "") {
														echo htmlentities("Ainda não foi devolvido!");
													} else {
											...
											<?php if ($result->RetrunStatus == 0) { ?>
												...
												<button type="submit" name="return" id="submit" class="btn btn-info">Retornar Livro </button>

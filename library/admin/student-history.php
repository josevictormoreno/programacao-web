...
?>
	...
	<head>
		...
		<title>ATIVIDADE PRÁTICA (ATP): Projeto Coisas Emprestadas | Histórico do Estudante</title>
				...
				<div class="row pad-botm">
					<div class="col-md-12">
						...
						<h4 class="header-line">#
							<?php echo $sid; ?> Histórico de Livros Emprestados
						</h4>
					</div>
					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<?php echo $result->FullName; ?> Detalhes
							</div>

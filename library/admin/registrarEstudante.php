...
<head>
    ...
    <title>ATIVIDADE PRÁTICA (ATP): Projeto Coisas Emprestadas | Gerenciar Estudantes</title>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h4 class="header-line">Gerenciar Estudantes</h4>
                </div>
                                                    ...
                                                    <a href="registrarEstudante.php?id=<?php echo htmlentities($result->id); ?>"
                                                        ...
                                                        <a
                                                            href="student-history.php?stdid=<?php echo htmlentities($result->StudentId); ?>"><button
                                                                class="btn btn-success"> Detalhes</button>
